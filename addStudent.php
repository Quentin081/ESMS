...
<header>
    ...
    <h1 style="text-align:center;">Current Student List</h1><br>
    ...
    if ($result->num_rows > 0) {
        ...
        while($row = $result->fetch_assoc()) {
            $phone = is_null($row['phone']) ? 'N/A' : $row['phone'];            
                echo "<tbody>
                    <tr>
    ...
    <button id="openModalBtn" class = "addTeacherBtn">Add a Student</button>
</div>

<div id="registerModal" class="modal">
    <div class="modal-content">
        <span class="close-btn" id="closeModalBtn">&times;</span>
        <h2 style="text-align:center;">Add a Student:</h2><br>
        <form action="registerStudent.php" method="POST">
            <div class="col-md-12 cold-md-offset-3" align="center">
                ...
                <div class="addUser">
                    ...
                    <input type="text" id="phoneNum" name="phone" placeholder= "Type NULL if N/A"><br><br>
                </div>
